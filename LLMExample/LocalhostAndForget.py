...
# To start this one, you need to open a terminal and run in this file:
# chainlit run app.py -w (being app the name of the file)
...
# The chatbot UI should now be accessible at http://localhost:8000
...
async def on_message(message: cl.Message):
    ...
    if message.content.lower() == "forget everything":
        ...
        await cl.Message("Oh oh, I've just forgotten our conversation history.").send()
        return
